...
namespace AMKDotNetTrainingBatch2.ConsoleApp
{
    public class EFCoreExample
    {
        public void Read()
        {
            ...
            List<BlogModel> lst = db.Blogs.Where(x => x.DeleteFlag == false) // 1,000
        ...
        public void Create()
        {
            ...
            Console.WriteLine(result > 0 ? "Saving Sussessful" : "Saving Failed");
        }
        ...
        {
            AppDbContext db = new AppDbContext();
            var item = db.Blogs.FirstOrDefault(x => x.BlogId == id); // top 2
